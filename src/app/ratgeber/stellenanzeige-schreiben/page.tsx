...
export default function StellenanzeigeSchreiben() {
  return (
    ...
    >
      ...
      <p>
        Studien zeigen: 84% der Bewerberenden lesen Stellenanzeigen auf ihrem Smartphone. 
        Wer in den ersten Sekunden nicht überzeugt, verliert qualifizierte Kandidat:innen 
        an die Konkurrenz.
      </p>

      <h2>Die perfekte Struktur einer Stellenanzeige</h2>
      <p>
        Eine überzeugende Stellenanzeige folgt einem bewährten Aufbau. Jeder Abschnitt 
      ...
      <ul>
        ...
        <li><strong>Vermeiden:</strong> „Wir suchen dich!" (ohne Details)</li>
      </ul>
      ...
      <h3>4. Das Anforderungsprofil</h3>
      <p>
      ...
      <div className="article-callout">
        ...
        <p>
          Füge einen kurzen Video-Clip hinzu, das euer Team zeigt. 
      ...
      <p>
        Nutze diese Checkliste, bevor du deine Stellenanzeige veröffentlichst:
      </p>
      <ul>
      ...
      <p>
        Diese Fehler kommen in Stellenanzeigen immer wieder vor – und kosten dich 
        Bewerbungen:
      </p>
      <ul>
      ...
      <p>
        <strong>Tipp:</strong> Teste deine Stellenanzeige mit dem A/B-Test-Tool, um zu sehen, 
        welche Version mehr Bewerbungen generiert.
      </p>

      <blockquote>
        „Die beste Stellenanzeige ist die, die sich liest wie eine Einladung – nicht wie eine Prüfung."
      </blockquote>
    </RatgeberBase>
  );
}
